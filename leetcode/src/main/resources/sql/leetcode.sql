...
CREATE TABLE `sys_answer`  (
  `answer_id` int(11) NOT NULL COMMENT ' 题解id',
...
CREATE TABLE `sys_answers_tags`  (
  `answer_id` int(11) NOT NULL COMMENT '题解的id',
...
CREATE TABLE `sys_commit`  (
  `commit_id` int(11) NOT NULL COMMENT '主键id',
...
CREATE TABLE `sys_questions_lists`  (
  `question_id` int(11) NOT NULL COMMENT ' question id',
  `list_id` int(11) NULL DEFAULT NULL COMMENT 'list（列表）id'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_questions_tags`  (
  `question_id` int(11) NOT NULL COMMENT 'question id',
  `tag_id` int(11) NOT NULL COMMENT ' tag 标签id',
  PRIMARY KEY (`question_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of sys_tag
-- ----------------------------
INSERT INTO `sys_tag` VALUES (42314234, '4231424', 0);
